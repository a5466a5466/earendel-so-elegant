	...
	return {
		...
		hooks: {
			...
			'astro:build:done': async ({ dir, logger }) => {
				...
				const labAssetPattern = /^(?:LabLayout\.|LabControls\.|LabNavigation\.|preferences(?:\.astro[^.]*)?\.|navigation(?:\.astro[^.]*)?\.|scroll(?:\.astro[^.]*)?\.|carousel(?:\.astro[^.]*)?\.|gallery-|starlight-birthday\.|summer-letter\.|moonlit-message-transparent\.)/;
