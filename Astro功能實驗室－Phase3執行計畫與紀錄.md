...
- 建立日期：2026-07-20
- 目前狀態：Step 1 F11、Step 2 F16、Step 3 F02 已完成；下一步為 Step 4 F21
...
開始 Phase 3・Step 4・F21 粒子、視差與 WebGL。先界定 CSS／Canvas 可完成的效果、測試矩陣與效能降級，再判斷是否真的需要開啟 Three.js dependency 決策閘門。
